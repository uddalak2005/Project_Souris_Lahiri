...
const academicData = [
    {
        ...
        description: "Specializing in Clinical Psychology with focus on cognitive behavioral therapy and neuro-rehabilitation techniques.",
        icon: "school"
    },
    {
        year: "2020 - 2023",
        ...
        description: "Graduated with First Class Honors. Conducted research on 'The Impact of Social Media on Adolescent Self-Esteem'.",
        icon: "psychology"
    },
    {
        year: "2018 - 2020",
        ...
        description: "Completed with focus on Humanities. Active member of the debate club and dramatic society.",
        icon: "menu_book"
    },
    {
        year: "2018",
        ...
        institution: "South Point High School",
        description: "Foundation years. Developed early interest in human behavior and literature.",
        icon: "draw"
    }
];

const Waypoint = ({ item, index }) => {
    const isEven = index % 2 === 0;

    return (
        <div className={`grid grid-cols-[auto_1fr] md:grid-cols-[1fr_auto_1fr] gap-4 md:gap-10 w-full mb-8 md:mb-24 items-center`}>
            ...
            */}
            <motion.div
                ...
                viewport={{ once: true }}
                className={`
                    bg-[#111826] p-6 rounded-xl border border-gray-800 shadow-lg hover:border-[#4cc9f0] transition-colors duration-300 relative
            ...
            >
                ...
                <p className="text-gray-300 text-sm md:text-base leading-relaxed inter">
                    {item.description}
                </p>
            </motion.div>
        </div>
                ...
                <div ref={containerRef} className="relative w-full mx-auto">
                    ...
                    <div className="space-y-4">
                        {academicData.map((item, index) => (
                            <Waypoint key={index} item={item} index={index} />
                        ))}
                    </div>
                </div>
